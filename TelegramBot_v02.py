...
async def get_token_transactions(session: aiohttp.ClientSession) -> List[Dict]:
    ...
    # Fallback to tokentx if no transactions or to capture token-specific transfers
    if not transactions:
...
async def send_to_telegram(
    ...
    # Try to get amount from transaction value or Transfer event
